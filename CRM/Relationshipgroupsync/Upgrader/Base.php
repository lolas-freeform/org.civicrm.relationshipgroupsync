 ...
 */
class CRM_Relationshipgroupsync_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Relationshipgroupsync_Upgrader(
        'org.civicrm.relationshipgroupsync',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Relationshipgroupsync_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
